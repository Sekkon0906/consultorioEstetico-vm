    ...
    <div className="min-h-screen bg-[#FAF6F1] text-[#2B2B2B] overflow-hidden">
      ...
      <section className="consultorio-desc-section max-w-6xl mx-auto py-16 md:py-20 px-6 text-center">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
          className="text-3xl md:text-4xl font-semibold text-[var(--brand-texto)] mb-8"
        >
          {t("description.title")}
        </motion.h2>
      ...
      <section className="consultorio-gallery-section px-4 pb-16 pt-4">
        <div className="max-w-5xl mx-auto mb-8 text-center">
          <h2 className="consultorio-gallery-title text-2xl md:text-3xl font-semibold text-[var(--brand-texto)]">
            {t("gallery.title")}
          </h2>
        </div>
